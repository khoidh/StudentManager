        ...
        <form action="http://localhost/webphp/index.php/admin/user.html" method="get" class="form" name="filter">
            <table cellpadding="0" cellspacing="0" width="100%" class="sTable mTable myTable withCheck" id="checkAll">
                ...
                <tr>
                    ...
                    <td style="width:80px;">Học sinh</td>
                    <td>Môn học</td>
                    <td>Điểm</td>
                    <td>Điểm</td>
                ...
                foreach ($result as $value) : ?>
                    <tr>
                        ...
                        <td class="option">
                            <a href="<?php echo base_url('point/');?>edit/<?php echo $value->id ?>" title="Chỉnh sửa" class="tipS ">
                                <img src="<?php echo public_url()?>/admin/images//icons/color/edit.png" />
                            </a>

                            <a href="<?php echo base_url('point/');?>delete/<?php echo $value->id ?>" title="Xóa" class="tipS verify_action" >
